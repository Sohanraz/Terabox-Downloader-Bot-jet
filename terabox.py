...
async def start_command(client, message):
    ...
    join_button = InlineKeyboardButton("Main Channel", url="https://t.me/Purohit_Bots")
    developer_button = InlineKeyboardButton("Developer", url="https://t.me/Sohan_Rajpurohit_1")
...
async def handle_message(client, message: Message):
    ...
    reply_msg = await message.reply_text("Trying To Download...")
